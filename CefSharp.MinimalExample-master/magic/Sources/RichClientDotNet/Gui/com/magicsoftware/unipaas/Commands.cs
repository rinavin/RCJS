...
// <returns></returns>
      public static String accumulatedTextGet(GuiMgControl guiMgControl)
      {
       ...
       {
          return GuiCommandQueue.getInstance().SerializeCommands();
       }
      ...
      public static void addAsync(CommandType commandType, Object obj, int line, String operation, String value)
      {
         GuiCommandQueue.getInstance().add(commandType, obj, line, operation, value);
      }
