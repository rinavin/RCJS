...
namespace com.magicsoftware.unipaas.gui.low
{
   ...
   internal abstract class GuiCommandQueueBase
   {
      ...
      {  //TODO: consolidate to minimal set of members
         ...
         internal List<int[]> intArrayList;
         internal List<int> intList;
         internal String[] itemsList;
         internal int layer;
         internal int line;
         internal GuiMgMenu menu;
         internal GuiMenuEntry menuEntry;
         internal MenuStyle menuStyle;
         internal MgColor mgColor;
         internal MgColor mgColor1;
         internal MgFont mgFont;
         internal int number;
         ...
         internal int x;
         internal int y;
         internal String userDropFormat;
         internal bool isHelpWindow;
         internal bool isParentHelpWindow;
         internal DockingStyle dockingStyle;
         internal ListboxSelectionMode listboxSelectionMode;
         internal Int64 contextID;
         internal int? runtimeDesignerXDiff;
         internal int? runtimeDesignerYDiff;
         internal bool createInternalFormForMDI;
